...
<layout:page-container title="LazyRecipes" activePage="editRecipe">
    <div class="container">
        ...
        <h2>Privacy Policy of <span class="website_url">www.lazyrecipes.com</span></h2>

        <p>At <span class="website_name">lazyrecipes</span>, we collect and manage user data according to the following
            Privacy Policy.</p>
        ...
        <p>We also use various technologies to collect information, and this may include sending cookies to your
            ...
            and campaign effectiveness. Our Privacy Policy was created with the help of the <a
                    href="https://www.privacy-policy-template.com">Privacy Policy Template Generator</a>. (ツ)_/¯</p>

        <h3>Use of the Data</h3>

        <p>We only use your personal information to provide you the <span class="website_name">lazyrecipes</span>
            services or to communicate with you about the Website or the services.</p>
