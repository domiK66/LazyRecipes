...
<layout:page-container title="LazyRecipes" activePage="recipeView">
    <div class="container">
        ...
        <c:choose>
            ...
            <c:when test="${favourite.checkboxBool == true}">
                <%--@elvariable id="favourite" type="at.fhj.ima.lazyrecipes.entity"--%>
                <form:form modelAttribute="favourite" method="post" action="/deleteFromFavourites?id=${recipe.id}">
            ...
            <c:otherwise>
                <%--@elvariable id="favourite" type="at.fhj.ima.lazyrecipes.entity"--%>
                <form:form modelAttribute="favourite" method="post" action="/saveToFavourites?id=${recipe.id}">
                    <input type="hidden" name="id" value="<c:out value="${favourite.id}"/>">
                    <fieldset>
                    <div class="mb-3">
                        <div class="mb-3">
